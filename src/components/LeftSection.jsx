...
function AllEmails({ data, loadMail }) {
	...
	return (
        <div className="border-r-2 bg-[#FAFAFA] dark:bg-black dark:border-[#33383F] border-[#E0E0E0] h-full overflow-y-auto scrollbar-hide">
